CREATE TABLE `monitoring_nodes` (
	...
	CONSTRAINT "monitoring_nodes_overall_condition_check" CHECK(overall_condition IN ('Normal', 'Warning', 'Danger'))
);
...
CREATE TABLE `telemetry_logs` (
	...
	CONSTRAINT "telemetry_logs_radon_condition_check" CHECK(radon_condition IN ('Normal', 'Warning', 'Danger')),
	CONSTRAINT "telemetry_logs_radon_threshold_check" CHECK(radon_min_threshold < radon_max_threshold),
	CONSTRAINT "telemetry_logs_soil_moisture_condition_check" CHECK(soil_moisture_condition IN ('Normal', 'Warning', 'Danger')),
	CONSTRAINT "telemetry_logs_soil_moisture_threshold_check" CHECK(soil_moisture_min_threshold < soil_moisture_max_threshold),
	CONSTRAINT "telemetry_logs_gyro_condition_check" CHECK(gyro_condition IN ('Normal', 'Warning', 'Danger')),
	CONSTRAINT "telemetry_logs_gyro_threshold_check" CHECK(gyro_min_threshold < gyro_max_threshold),
	CONSTRAINT "telemetry_logs_rainfall_condition_check" CHECK(rainfall_condition IN ('Normal', 'Warning', 'Danger')),
	CONSTRAINT "telemetry_logs_rainfall_threshold_check" CHECK(rainfall_min_threshold < rainfall_max_threshold),
	CONSTRAINT "telemetry_logs_overall_condition_check" CHECK(overall_condition IN ('Normal', 'Warning', 'Danger'))
);
--> statement-breakpoint
